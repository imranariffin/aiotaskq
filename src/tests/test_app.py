...
@pytest.mark.parametrize(
    ...
    [
        (
            # Case 1: Tasks are defined using an explicit Aiotaskq instance with
        ...
        (
            # Case 2: Tasks are defined using an explicit Aiotaskq instance with
            # default name "app", and
            "sample_apps.simple_app.aiotaskq.app",
            # We should instantiate Aiotaskq from the import path to the instance.
            simple_app,
        ...
        (
            # Case 3: Tasks are defined using an explicit Aiotaskq instance with custom name, and
            "sample_apps.simple_app.aiotaskq:some_app",
            # We should instantiate Aiotaskq from the import path to the instance.
            simple_app,
        ),
        (
            # Case 4: Tasks are defined using an explicit Aiotaskq instance, and
            "sample_apps.simple_app.aiotaskq",
            # We should instantiate Aiotaskq from the import path to the instance.
            simple_app,
        ),
        (
            # Case 5: Tasks are defined using an explicit Aiotaskq instance, and
            "sample_apps.simple_app",
            # We should instantiate Aiotaskq from the import path to the instance.
            simple_app,
        ),
        (
            # Case 6: Tasks are defined inside a module without using explicit Aiotaskq
            # instance, and
